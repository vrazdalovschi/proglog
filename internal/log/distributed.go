...
import (
	...
	raftboltdb "github.com/vrazdalovschi/proglog/external/github.com/hashicorp/raft-boltdb"
	"io"
	"net"
	"os"
	"path/filepath"
...
func (l *DistributedLog) apply(reqType RequestType, req proto.Marshaler) (interface{}, error) {
